...
<body>
	...
	<form action="<?php echo $_SERVER['PHP_SELF'];?> " id=""class="buscar-id" method="POST">

	<div class="row">
		<div class="col-7">

			<?php	$idpaciente = $_GET['idpaciente']; ?>
 ...
 <?php 
		...
		while($consulta=mysqli_fetch_array($resultados))
		{
			...
			$valores['edad']=$consulta['edad'];
			$valores['especie']=$consulta['especie'];
			$valores['raza']=$consulta['raza'];
			$valores['sexo']=$consulta['sexo'];
			$valores['color']=$consulta['color'];
